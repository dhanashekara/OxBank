...
public class LoanControllerTest {
	...
	public void setup() {
	  ...
	  @Test public void createLoanTest() throws Exception {
	  
	  //Officer officer = new Officer(10); //Customer customer = new Customer(10);
	  
	  //Positive case Loan loan = new Loan(10,"pending",500,10,10); ObjectMapper om
	  = new ObjectMapper(); String expected = om.writeValueAsString(loan);
	  ...
	  //Negative case loan = null; ObjectMapper omForNegative = new ObjectMapper();
